...
- (void)viewDidLoad
{
    ...
    recipe18.name = @"Burrow";
    recipe18.ingredients = [NSArray arrayWithObjects:@"The student-run coffee house, musical venue and campus art space in the basement of Larson Hall.", nil];
