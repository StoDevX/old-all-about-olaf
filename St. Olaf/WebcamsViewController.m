...
#import "WebcamsViewController.h"
#import <sys/socket.h>
#import <netinet/in.h>
#import <SystemConfiguration/SystemConfiguration.h>

@interface WebcamsViewController ()
@property (strong, nonatomic) MPMoviePlayerController *streamPlayer;

@end

@implementation WebcamsViewController
...
- (void)viewDidLoad
{
    ...
    else
    {
        ...
        NSURL *streamURL = [NSURL URLWithString:@"http://stolaf-flash.streamguys.net/webcams/himom.stream/playlist.m3u8"];
