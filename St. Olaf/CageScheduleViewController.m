...
#import "CageScheduleViewController.h"
#import "RSSLoader4.h"
#import "RSSItem4.h"
...
@interface CageScheduleViewController ()
...
@implementation CageScheduleViewController
@synthesize subView;
...
- (void)viewDidLoad
{
    ...
    if([self hasConnectivity] == NO) {
        ...
        feedURL = [NSURL URLWithString:@"http://legacy.cafebonappetit.com/rss/menu/262"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(day >= 10){
        ...
        object.contentEncoded = [object.contentEncoded stringByReplacingOccurrencesOfString:@"[breakfast] " withString:@""];
        object.contentEncoded = [object.contentEncoded stringByReplacingOccurrencesOfString:@"[Hot Sandwich Feature] " withString:@""];
        object.contentEncoded = [object.contentEncoded stringByReplacingOccurrencesOfString:@"[Saut&amp;#233; Special] " withString:@""];
        object.contentEncoded = [object.contentEncoded stringByReplacingOccurrencesOfString:@"[Saut&#233; Special] " withString:@""];
        object.contentEncoded = [object.contentEncoded stringByReplacingOccurrencesOfString:@"[Chili of the Week] " withString:@""];
        object.contentEncoded = [object.contentEncoded stringByReplacingOccurrencesOfString:@"[Burger of the Week] " withString:@""];
        object.contentEncoded = [object.contentEncoded stringByReplacingOccurrencesOfString:@"[Grab-n-Go Sandwich] " withString:@""];
        object.contentEncoded = [object.contentEncoded stringByReplacingOccurrencesOfString:@"[Grab-n-Go Salad] " withString:@""];
        ...
        if([object.title isEqualToString: todayIs]){
            ...
            CGSize constraint = CGSizeMake(CELL_CONTENT_WIDTH - (CELL_CONTENT_MARGIN * 2), 20300.0f);
            CGSize size = [text sizeWithFont:[UIFont systemFontOfSize:FONT_SIZE] constrainedToSize:constraint lineBreakMode:UILineBreakModeWordWrap];
            cell.textLabel.text = object.contentEncoded;
            cell.textLabel.numberOfLines = 0;
            [cell setFrame:CGRectMake(CELL_CONTENT_MARGIN, CELL_CONTENT_MARGIN, CELL_CONTENT_WIDTH - (CELL_CONTENT_MARGIN * 2), MAX(size.height, 4744.0f))];
        } else {
        }
        return cell;
    }
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if([object.title isEqualToString: todayIs]){
        ...
        CGSize constraint = CGSizeMake(CELL_CONTENT_WIDTH - (CELL_CONTENT_MARGIN * 2), 20000.0f);
        CGSize size = [text sizeWithFont:[UIFont systemFontOfSize:FONT_SIZE] constrainedToSize:constraint lineBreakMode:UILineBreakModeWordWrap];
        CGFloat height = MAX(size.height+size.height/1.2, 1044.0f);
        return height + (CELL_CONTENT_MARGIN * 2.4);
    }
    else {
        return 0;
