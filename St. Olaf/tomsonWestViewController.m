...
#import "tomsonWestViewController.h"
#import <sys/socket.h>
#import <netinet/in.h>
#import <SystemConfiguration/SystemConfiguration.h>

@interface tomsonWestViewController ()
@property (strong, nonatomic) MPMoviePlayerController *streamPlayer;

@end

@implementation tomsonWestViewController
...
- (void)viewDidLoad
{
    ...
    if([self hasConnectivity] == NO) {
        ...
        NSURL *streamURL = [NSURL URLWithString:@"http://stolaf-flash.streamguys.net/webcams/tomsonwest.stream/playlist.m3u8"];
...
{
    UIViewController *vc = [self.storyboard instantiateViewControllerWithIdentifier:@"HiMom"];
...
{
    UIViewController *vc = [self.storyboard instantiateViewControllerWithIdentifier:@"East"];
    UINavigationController *navController = [[UINavigationController alloc] initWithRootViewController:vc];
    [self presentViewController:navController animated:NO completion:nil];
}
*/
