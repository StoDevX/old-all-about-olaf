...
#import "movieBusViewController.h"
#import <sys/socket.h>
#import <netinet/in.h>
#import <SystemConfiguration/SystemConfiguration.h>

@interface movieBusViewController ()

@end

@implementation movieBusViewController
...
- (void)viewDidLoad
{
    ...
    if([self hasConnectivity] == NO) {
        ...
        NSString *urlString = @"http://wp.stolaf.edu/sa/transportation/moviebus/";
        //2
