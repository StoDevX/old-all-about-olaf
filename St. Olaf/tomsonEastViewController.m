...
#import "tomsonEastViewController.h"
#import <MediaPlayer/MediaPlayer.h>
#import <sys/socket.h>
#import <netinet/in.h>
#import <SystemConfiguration/SystemConfiguration.h>

@interface tomsonEastViewController ()
@property (strong, nonatomic) MPMoviePlayerController *streamPlayer;

@end

@implementation tomsonEastViewController
...
- (void)viewDidLoad
{
    ...
    if([self hasConnectivity] == NO) {
        ...
        NSURL *streamURL = [NSURL URLWithString:@"http://stolaf-flash.streamguys.net/webcams/tomsoneast.stream/playlist.m3u8"];
...
{
    UIViewController *vc = [self.storyboard instantiateViewControllerWithIdentifier:@"West"];
