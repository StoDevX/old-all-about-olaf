...
#import "mobileCalViewController.h"
#import <sys/socket.h>
#import <netinet/in.h>
#import <SystemConfiguration/SystemConfiguration.h>

@interface mobileCalViewController ()

@end

@implementation mobileCalViewController
...
- (void)viewDidLoad
{
    ...
    if([self hasConnectivity] == NO) {
        ...
        NSString *urlString = @"http://m.stolaf.edu/calendar";
        //2
